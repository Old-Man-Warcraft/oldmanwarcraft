...
- **Memory System**: Persistent knowledge graph stores project information (see memory-usage.md)
...
<memory_usage>
- **Knowledge Graph**: Persistent memory stores project architecture, modules, systems, configurations
- **Search Memory**: Use `mcp5_search_nodes` to find relevant information before implementing
- **Store Discoveries**: Document critical issues, bugs, and safety concerns in memory
- **Update Regularly**: Add observations when systems change or new information discovered
- **Check Before Acting**: Search memory for known issues before modifying critical systems
- See **memory-usage.md** for complete memory system guidelines
</memory_usage>
