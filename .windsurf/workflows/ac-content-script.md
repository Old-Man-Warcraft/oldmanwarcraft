---
description: Add or fix AzerothCore content scripts (CreatureScript, SpellScript, InstanceMapScript, commands)
---

# AzerothCore content scripts

Use when working under `src/server/scripts/`, boss scripts, spell scripts, SAI-adjacent C++, or script_loader registration.
...
Run the `/ac-sql-updates` workflow for `creature_template`, `smart_scripts`, `spell_*` tables, etc.
