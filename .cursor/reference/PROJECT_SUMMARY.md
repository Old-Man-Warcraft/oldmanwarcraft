...
**Cursor / AI documentation (2026-04):** Project rules: `.cursor/rules/*.mdc`. Skills and workflows: `.cursor/skills/<name>/SKILL.md` (including `workflow-*`). Canonical technical index: `CLAUDE.md`. Long-form archive: `.cursor/reference/windsurf-rules-archive.md`. Crash guide: `.cursor/docs/crash-debugging.md`. Helper scripts: `.cursor/scripts/windsurf/`. Prefer `.cursor/` over `.windsurf/` when using Cursor.
