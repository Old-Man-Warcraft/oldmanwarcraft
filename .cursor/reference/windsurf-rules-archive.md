...
> **Archive / historical:** Prefer **`.cursor/rules/*.mdc`**, **`CLAUDE.md`**, and **`PROJECT_SUMMARY.md`** for current **Old Man Warcraft** policy (production-only host, GitLab/GitHub layout, Notion runbooks). Content below may still mention a local dev realm (8086); treat that as generic AzerothCore guidance unless your Notion says otherwise.
