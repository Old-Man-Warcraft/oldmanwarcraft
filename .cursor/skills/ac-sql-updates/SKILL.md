...
name: ac-sql-updates
description: >-
  Authors AzerothCore SQL pending updates for acore_world, characters, or auth.
  Use when adding or fixing quests, creatures, loot, spells data, SAI, or any
  table change; when the user mentions pending_db_* or database patches.
---
