-- DB update: Skadi the Ruthless (Utgarde Pinnacle)
-- Ports AzerothCore #25359 (gauntlet adds / Grauf paths / spell_area) and #25364 (heroic spear script).
-- See GitLab oldmanwarcraft #14.
